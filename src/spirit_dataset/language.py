...
TRANSLATIONS: dict[str, tuple[str, str]] = {
    ...
    "네 이명은 뭐야?": ("What is your epithet?", "你的別称是什麼？"),
    "너는 어떤 유형의 정령이야?": ("What kind of Soul are you?", "你是哪种类型的精靈？"),
    ...
    "내 이명은 {value}": ("I'm called {value}", "我的別称是{value}"),
    ...
    "구원자는 과거에서 소환된 인간": (
        "You were summoned from the past.",
        "救贖者是從過去召喚來的人类",
    ),
    "구원자는 정령과 계약하는 정령술사": (
        "You form contracts with Souls.",
        "救贖者是與精靈締約的精靈術士",
    ),
    "에버톡으로 구원자와 메시지를 나눈다": (
    ...
    "정령은 죽으면 정령석으로 돌아가 잠든다": (
        "We sleep in Soulstones on death.",
        "我們死後回到精靈石中沉睡",
    ),
    "긴 잠에서 깨면 옛 기억이 흐려진다": (
    ...
    "하늘에 게이트가 열려 마물이 쏟아진다": (
        "Gates pour monsters into Eden.",
        "我生活的天空中門會湧出魔物",
    ),
    "일곱 나라가 정령 연합군을 만들었다": (
        "Seven nations formed our army.",
        "七國組成了我們的精靈联軍",
    ),
    "유리아는 솔레이 왕국의 여왕": ("Yuria is Solrey's queen.", "尤莉婭是索雷王國的女王"),
    "메피스토펠레스는 방주의 인공 정령": (
        "Mephi is the Ark's built Soul.",
        "梅菲斯托佩勒斯是方舟的人造精靈",
    ),
    "구원자는 아케나인의 영주": ("You are the lord of Arkenine.", "救贖者是阿刻奈因的领主"),
    "천사형과 악마형 정령은 드물고 강하다": (
        "Angel and Demon Souls are rare.",
        "天使型與恶魔型精靈稀有而強大",
    ),
    ...
    "정령 연합군은 누가 만들었어?": ("Who formed the Soul Alliance army?", "是誰組成了精靈联軍？"),
    "유리아는 어떤 위치에 있어?": ("What position does Yuria hold?", "尤莉婭是什麼身份？"),
    "메피스토펠레스는 어떤 정령이야?": (
        "What kind of Soul is Mephistopheles?",
        "梅菲斯托佩勒斯是什麼樣的精靈？",
    ),
    "내가 영주로 있는 곳이 어디지?": ("Where am I the lord?", "我是哪片领地的领主？"),
    "천사형과 악마형은 흔해?": ("Are Angel and Demon Souls common?", "天使型與恶魔型精靈常見嗎？"),
