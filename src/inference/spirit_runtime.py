...
class SpiritRuntime:
    ...
    def open_session(self, spirit_id: str, language: str = "ko") -> SpiritSession:
        return SpiritSession(self, spirit_id, language)
    ...
    def reply(
        ...
        if (
            ...
            or messages[0]["content"] != spirit_selection_header(persona_id)
        ):
